...
public class Easy_Abs2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final Intent intent = new Intent(Easy_Abs2.this, Easy_Abs3.class);
                Timer countDownDialog = new Timer(Easy_Abs2.this, android.R.style.Theme_Light);
                countDownDialog.show();

                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        DatabaseHandler db = DatabaseHandler.getInstance(Easy_Abs2.this); //Deklarasi database handler 'online'
    ...
    public void onBackPressed(){
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(Easy_Abs2.this);
        ...
        alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface d, int which) {
                Intent intent = new Intent(Easy_Abs2.this, WorkoutDetails_Abs.class);
                startActivity(intent);
                Toast.makeText(Easy_Abs2.this, "Successfully ran out from the workout", Toast.LENGTH_SHORT).show();
                d.dismiss();
            }
        });
